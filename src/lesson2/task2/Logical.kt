...
fun daysInMonth(month: Int, year: Int): Int {
    ...
    if (month < 8)
        return if (month % 2 == 0) 30
        else 31
    return return if (month % 2 == 0) 31
    else 30
}
 ...
 */
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean = (a <= r && c <= s) || (c <= r && a <= s) ||
        (b <= r && c <= s) || (c <= r && b <= s) || (a <= r && b <= s) || (b <= r && a <= s)
